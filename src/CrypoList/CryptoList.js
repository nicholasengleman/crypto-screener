...
class CryptoList extends React.Component {
	...
	sortByMkCap() {
		if (typeof this.state.sortType.MarketCap === "undefined") {
			...
			this.setState({
				sortType: { MarketCap: !this.state.sortType.MarketCap }});
		}
	}
	...
	sortByPrice() {
		if (typeof this.state.sortType.Price === "undefined") {
			...
			this.setState({
				sortType: { Price: !this.state.sortType.Price }});
		}
	}
	...
	sortByChange1H() {
		if (typeof this.state.sortType.Change1H === "undefined") {
			...
			this.setState({
				sortType: { Change1H: !this.state.sortType.Change1H }});
		}
	}
	...
	sortByChange24H() {
		if (typeof this.state.sortType.Change24H === "undefined") {
			...
			this.setState({
				sortType: { Change24H: !this.state.sortType.Change24H }});
		}
	}
	...
	sortByChange7D() {
		if (typeof this.state.sortType.Change7D === "undefined") {
			...
			this.setState({
				sortType: { Change7D: !this.state.sortType.Change7D }});
		}
	}
	...
	sortByVolume() {
		if (typeof this.state.sortType.Volume === "undefined") {
			...
			this.setState({
				sortType: { Volume: !this.state.sortType.Volume }});
		}
	}
		...
		return (
			<main>
				<ul className="CryptoList">
					<CryptoListHeader sortByMkCap={this.sortByMkCap}
					...
					{
						sortedData.sort((a, b) => {
							if (this.state.sortType.Price === true)      		{ return a.price_usd - b.price_usd; }
							if (this.state.sortType.Price === false)     		{ return b.price_usd - a.price_usd; }
							if (this.state.sortType.MarketCap === true) 		{ return a.market_cap_usd - b.market_cap_usd; }
							if (this.state.sortType.MarketCap === false) 		{ return b.market_cap_usd - a.market_cap_usd; }
							if (this.state.sortType.Change1H === true)  		{ return a.percent_change_1h - b.percent_change_1h; }
							if (this.state.sortType.Change1H === false) 		{ return b.percent_change_1h - a.percent_change_1h; }
							if (this.state.sortType.Change24H === true)  		{ return a.percent_change_24h - b.percent_change_24h; }
							if (this.state.sortType.Change24H === false) 		{ return b.percent_change_24h - a.percent_change_24h; }
							if (this.state.sortType.Change7D === true)  		{ return a.percent_change_7d - b.percent_change_7d; }
							if (this.state.sortType.Change7D === false) 		{ return b.percent_change_7d - a.percent_change_7d; }
							if (this.state.sortType.Volume=== true)  			{ return a['24h_volume_usd'] - b['24h_volume_usd']; }
							if (this.state.sortType.Volume === false) 			{ return b['24h_volume_usd'] - a['24h_volume_usd']; }
							return 0;
						})
							.map(crypto => (
